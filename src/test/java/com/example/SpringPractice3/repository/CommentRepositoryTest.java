...
class CommentRepositoryTest {
    ...
    void findByArticleId() {
        ...
        //4. 비교 및 검증
        assertEquals(expected.toString(), comments.toString(),"4번 글의 모든 댓글들 출력!");
    }

    @Test
    @DisplayName("특정 닉네임의 댓글 모두 조회")
    void findByNickname() {
        ...
        Comment c = new Comment(7L,new Article(4L,"당신의 인생 영화는?","댓글 고고고"),nickname,"조깅");
        List<Comment> expected = Arrays.asList(a, b, c);
